...
persons-own [
  ...
  crossing-part  ;; it divides the crossing into parts
...
to draw-sidewalk
  ...
  ask patches with [pxcor mod 40 = 1 or pxcor mod 40 = 2 or pxcor mod 40 = 3
                    or pxcor mod 40 = 35 or pxcor mod 40 = 34 or pxcor mod 40 = 33
                    or pycor mod 22 = 1 or pycor mod 22 = 2 or pycor mod 22 = 3
                    or pycor mod 22 = 15 or pycor mod 22 = 16 or pycor mod 22 = 17] [
    set pcolor brown + 2
    sprout-persons 1 [
      set shape "person"
      set color white
...
to draw-crossings
  ...
  ask patches with [meaning = "road-up"] [
    sprout-crossings 1 [
      set shape "crossing"
      set color white
      set heading 0
  ...
  ask patches with [meaning = "road-down"] [
    sprout-crossings 1 [
      set shape "crossing"
      set heading 90
      set color white
...
; to place-people
  ...
  ;  set speed random-normal mean-speed std-dev-speed
  ;]
;end
...
to move-people
  ask persons [
    if not waiting? [
      let target one-of patches with [meaning = "crossing" and will-cross? and used < 2]
      if target != nobody [
        face target
        fd speed
        if distance target < 1 [
          set waiting? true
          ask target [set used used + 1]
        ]
      ]
    ]
  ]
