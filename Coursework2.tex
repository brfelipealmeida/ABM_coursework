...
The model is developed to simulate pedestrians' flows trying to cross a street. Thus, the pedestrians are placed randomly on the sidewalk. Pedestrians can walk, wait, or cross the street based on walk time and the crossing part.
